...
$('.waifu-tool .fui-info-circle').click(function () {
  window.open('http://www.hezi.site/article/608ad935f09e5c55ae3e7e07');
});
...
var waifuJson = {
  "mouseover": [{
    ...
    },
    {
      ...
      "text": ["去阅读几篇文章吧，知识就是力量~"]
    },
    {
      "selector": "a[href^='/background']",
      "text": ["点这里能看见背景的全貌哦~"]
    },
    {
    ...
    {
      "selector": "a[href^='/life']",
      "text": ["去看看站长平常在干什么吧！"]
    },
    {
      "selector": "a[href^='/friend']",
      "text": ["要串门子吗？去吧，站长不会在意的。"]
    },
    {
    ...
    {
      "selector": ".music-player-before",
      "text": ["光看也是很无聊的，陪我听听音乐吧❤"]
    },
    {
      "selector": ".download",
      "text": ["打开一个新页面吧，两个文章一起看。"]
    },
    {
      "selector": "a[href^='https://github.com/GorgeousBox']",
      "text": ["去站长的小仓库里看看吧"]
    },
    {
      "selector": ".icon-bird-xiaoniao",
      "text": ["站长才不你看他的关注呢"]
    },
    {
      "selector": "a[href^='https://weibo.com/u/7007976582?is_all=1']",
      "text": ["去站长的微博看看吧，他的微博很可怜的"]
    },
    {
      "selector": ".icon-weixin1",
      "text": ["从这里加站长微信吧，什么？你想要我的微信，才，才不给你"]
    },
    {
      "selector": "a[href^='http://wpa.qq.com/msgrd?v=3&uin=2056439016&site=qq&menu=yes']",
      "text": ["在QQ上找站长聊聊吧"]
    },
    {
